...
// new Person().calculateAge.bind(obj)() //  Привязываем к методу класса Person объект obj , как this
...
// Привязываем к методу объекта person объект person2 , как this и передаем аргумент 'Стройке' в методe calculateAge
//Результат : Vlad , 91 год работает на стройке


// Итог: bind,call,aplly мы используем для привязки объекта , как this в методы объектов, классов и функкий конструкторов
