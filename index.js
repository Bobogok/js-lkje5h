...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Как ты понимаешь что такое Event Loop?
//
...
// Примеры задач
//
//1. Когда загружается внешний скрипт <script src="...">, то задача – это выполнение этого скрипта.
//
...
//                                                               //
//let i = 0;                                                     //    В этом коде показно, что JS не будет производить
//                                                               //    событие пользователя 'mouseover' т.к у него стоит
// let start = Date.now();                                       //    более важная задача: Выполнить этот скрипт.
//                                                               //    То есть событие пользователя встает в конец очереди
// function count() {                                            //    макрозадач. Но в практике это нам не подходит, ниже 
//                                                               //    мы сделаем так, чтобы js мог выполнять этот скрипт, а
//   // делаем тяжёлую работу                                    //    так-же события пользователя
//   for (let j = 0; j < 1e9; j++) {                             //
//     i++;                                                      //
//   }                                                           //
//                                                               //
...
// function count() {                                            //
//                                                               //
//   if (i < 1e9 - 1e6) {                                        //  Ставим условие в if и планируем вызов функции 
//     setTimeout(count);                                        //  с помощью этого мы дали JS так сказать "Глоток воздуха"                                       
//   }                                                           //  чтобы она могла выполнять события пользователя 
//                                                               //  (В JS setTimeout и setInterval без timeout имеют задержку 4 мс)
//   do {                                                        //
//     i++;                                                      //
//   } while (i % 1e6 != 0);                                     //                           
//                                                               //                      
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////                                                             
// Пример 2: делаем что-нибудь после события                    
//                                                              
...
//Например:
//
//setTimeout(() => log("timeout"));   // timeout появляется последним, потому что это макрозадача.
// Promise.resolve()                  // promise появляется вторым, потому что .then проходит через очередь микрозадач и выполняется после текущего синхронного кода.
// .then(() => log("promise"));
// log("code");                       // code появляется первым, т.к. это обычный синхронный вызов.
//
// Итог: 

// 1. Выбрать и исполнить старейшую задачу из очереди макрозадач (например, «script»).
// 2. Исполнить все микрозадачи:
//     Пока очер едь микрозадач не пуста: - Выбрать из очереди и исполнить старейшую микрозадачу
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Что такое Event Propogation, Event Bubbling, Event Target, Event Capturing?
//                                                             
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Event Propogation -------
...
// 
// 
// Простыми словами, event.target — это элемент, в котором происходит событие,или элемент, вызвавший в котором происходит событие, или элемент, вызвавший
//                                                                                           /\
//                                                                                           ||
//                                                                                           ------------ Event.target
//
//
// Event Capturing ----------------------------------------------->       //Когда событие происходит в элементе DOM, оно происходит не только в нем. В фазе погружения ..                                                                        //событие опускается от объекта Window до цели события через всех его предков.
//
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//
// Куки обычно устанавливаются веб-сервером при помощи заголовка Set-Cookie. Затем браузер будет
// автоматически добавлять их в (почти) каждый запрос на тот же домен при помощи заголовка Cookie.
//
